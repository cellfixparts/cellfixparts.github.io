    ...
    <div id="content" class="site-content sitemap" role="main">
      ...
      <div class="archive-content">
			<div class="sitemap-item">
			  <div class="sitemap-pages">
				<h2>
				  <?php esc_html_e('Pages','megashop-multistore');?>
				</h2>
				<ul>
       ...
       <div class="sitemap-item">
			  <div class="sitemap-category">
				<h2>
				  <?php esc_html_e( 'Category Archives','megashop-multistore'); ?>
				</h2>
				<ul>
				  <?php wp_list_categories( array( 'feed' => esc_html__( 'RSS', 'megashop-multistore' ), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false ) ); ?>
				</ul>
			  </div>
			  <div class="clear"></div>
			  <div class="sitemap-month-archieves">
				<h2>
				  <?php esc_html_e( 'Monthly Archives','megashop-multistore'); ?>
				</h2>
				<ul>
			  ...
			  <div class="sitemap-authors">
				<h2>
				  <?php esc_html_e( 'Author Archives','megashop-multistore'); ?>
				</h2>
				<ul>
      ...
      <div class="sitemap-item">
          <div class="sitemap-posts">
            <h2>
              <?php esc_html_e( 'Blog Posts','megashop-multistore'); ?>
            </h2>
            <ul>
              <?php 
