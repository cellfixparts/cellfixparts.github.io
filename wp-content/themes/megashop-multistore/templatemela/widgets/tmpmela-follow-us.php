...
class FollowMeWidget extends WP_Widget
{
	...
	<?php if(!empty($linkURL1)) :  ?>
		<a href="<?php echo esc_url($linkURL1); ?>" title="<?php echo esc_html('Facebook', 'megashop-multistore');?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL2)) :  ?>
		<a href="<?php echo esc_url($linkURL2); ?>" title="<?php echo esc_html('Twitter', 'megashop-multistore');?>" class="twitter icon"><i class="fa fa-twitter"></i></a>
	<?php endif; ?>	
	<?php if(!empty($linkURL3)) :  ?>
		<a href="<?php echo esc_url($linkURL3); ?>" title="<?php echo esc_html('Linkedin', 'megashop-multistore');?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL4)) :  ?>
		<a href="<?php echo esc_url($linkURL4); ?>" title="<?php echo esc_html('RSS', 'megashop-multistore');?>" class="rss icon"><i class="fa fa-rss"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL5)) :  ?>
		<a href="<?php echo esc_url($linkURL5); ?>" title="<?php echo esc_html('Youtube', 'megashop-multistore');?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
	<?php endif; ?>	
	<?php if(!empty($linkURL6)) :  ?>
		<a href="<?php echo esc_url($linkURL6); ?>" title="<?php echo esc_html('Pinterest', 'megashop-multistore');?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL7)) :  ?>
		<a href="<?php echo esc_url($linkURL7); ?>" title="<?php echo esc_html('Google Plus', 'megashop-multistore');?> " class="google-plus icon"><i class="fa fa-google-plus"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL8)) :  ?>
		<a href="<?php echo esc_url($linkURL8); ?>" title="<?php echo esc_html('Skype', 'megashop-multistore');?>" class="skype icon"><i class="fa fa-skype"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL9)) :  ?>
		<a href="<?php echo esc_url($linkURL9); ?>" title="<?php echo esc_attr('Instagram', 'megashop-multistore');?>" class="instagram icon"><i class="fa fa-instagram"></i></a>
	<?php endif; ?>	
	</li>
	</ul>
</div>
