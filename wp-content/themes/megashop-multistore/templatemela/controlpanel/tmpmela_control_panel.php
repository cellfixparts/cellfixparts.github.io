...
<style type="text/css">
	...
	.service-text.text1{color:#<?php echo esc_attr(get_option('tmpmela_header_cms_text_color')) ; ?>}
	.service-text.text2{color:#<?php echo esc_attr(get_option('tmpmela_header_cms_text_color')) ; ?>}
	...
	.site-header{
	 ...
	 .header-category ul.sidebar-category-inner > li a ,.more-wrap ,.box-category {color:#<?php echo esc_attr(get_option('tmpmela_sidebar_category_link_color')); ?>;}
