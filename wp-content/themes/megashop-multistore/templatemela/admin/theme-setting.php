...
$options2[] = array("label" => "Header Service CMS Setting",
    ...
    "type" => "Title-1");
$options2[] = array("id" => "tmpmela_show_header_cms",
    "label" => "Show Header CMS Service Setting?",
    "type" => "select",
    "description" => "Displays Header CMS Service. ",
    "options" => array('yes' => 'Yes', 'no' => 'No'));
$options2[] = array("id" => "tmpmela_header_cms_text",
    "label" => "Header CMS Text",
    "type" => "textbox",
    "std" => "Free Shipping",
    "description" => "Your Header CMS Text. ");
$options2[] = array("id" => "tmpmela_header_cms_text_color",
    "label" => "Header CMS Text color",
    "type" => "textbox-1",
    "std" => "FFFFFF",
    "description" => "Header CMS Service Text color. ");
...
$options2[] = array("id" => "tmpmela_contact_text_color",
    "label" => "Header Contact Text color",
    "type" => "textbox-1",
    "std" => "FFFFFF",
...
<div class="main-block">
        ...
        <div class="wrap">
            ...
            <div class="tmpmela_contents">
                <div class="entry-content">
                    <p>
                        <a target="_Self" href="#" title="<?php esc_attr_e('Templatemela', 'megashop-multistore'); ?>">TemplateMela</a> <br/>
    ...
    <div id="tab-container" class='tab-container'>
        <ul class='etabs'>
            <li class="tab first">
                <a href="#General" title="<?php esc_html_e('General Settings', 'megashop-multistore'); ?>">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/general_setting.png" alt="<?php echo esc_attr_e('general', 'megashop-multistore'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('General', 'megashop-multistore'); ?>
                    </span>
                </a>
            </li>
            <li class="tab header">
                <a href="#Header">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/header_setting.png" alt="<?php echo esc_attr_e('header', 'megashop-multistore'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('Header', 'megashop-multistore'); ?>
                    </span>
                </a>
            </li>
            <li class="tab">
                <a href="#Content">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/content_settings.png" alt="<?php echo esc_attr_e('content', 'megashop-multistore'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('Content', 'megashop-multistore'); ?>
                    </span>
                </a>
            </li>
            <li class="tab">
                <a href="#Footer">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/footer_settings.png" alt="<?php echo esc_attr_e('footer', 'megashop-multistore'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('Footer', 'megashop-multistore'); ?>
                    </span>
                </a>
            </li>
            <?php if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) : ?>
                <li class="tab">
                    <a href="#product">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/product_setting.png"  alt="<?php echo esc_attr_e('product', 'megashop-multistore'); ?>"/>
                        <span class="title">
                            <?php echo esc_attr_e('Product', 'megashop-multistore'); ?>
                        </span>
                    </a>
                </li>
            <?php endif; ?>
                    ...
                    <form enctype="multipart/form-data" method="post" id="settingForm1" name="settingForm1">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_html__('General Settings', 'megashop-multistore'); ?>
                                </label>
                            </div>
                            <?php
                            $i = 0;
                ...
                <div id="Header">
                    <form enctype="multipart/form-data" method="post" id="settingForm2" name="settingForm2">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_html__('Header Settings', 'megashop-multistore'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options2
                ...
                <div id="Content">
                    <form enctype="multipart/form-data" method="post" id="settingForm3" name="settingForm3">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_attr_e('Content Settings', 'megashop-multistore'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options3
                ...
                <div id="Footer">
                    <form enctype="multipart/form-data" method="post" id="settingForm4" name="settingForm4">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_html__('Footer Settings', 'megashop-multistore'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options4
