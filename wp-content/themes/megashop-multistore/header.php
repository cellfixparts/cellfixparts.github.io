...
<div id="site-header"> <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"> <img src="<?php header_image(); ?>" width="<?php echo esc_attr(get_custom_header()->width); ?>" height="<?php echo esc_attr(get_custom_header()->height); ?>" alt="<?php echo esc_attr_e('Siteheader','megashop-multistore'); ?>"> </a> </div>
<?php endif; ?>
<!-- Header -->
                                    ...
                                    if (is_user_logged_in()) {
                                        ...
                                        <?php if ($myaccount_page_id): ?>
                                            <a class="logout" href="<?php echo esc_url($logout_url); ?>">
                                                <?php echo esc_html_e('Logout', 'megashop-multistore'); ?>
                                            </a>
                                        <?php endif; ?>
                                    <?php } else {
                                        $myaccount_page_id = get_option('woocommerce_myaccount_page_id'); ?>
                                        <?php if ($myaccount_page_id): ?>
                                            <a class="login" href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>">
                                                <?php echo esc_html_e('Login', 'megashop-multistore'); ?>
                                            </a>
                                        <?php endif; ?>
                                    <?php } ?>
                                </div>
							...
							<?php if ( has_nav_menu('header-menu') ): ?> 	
										...
										<div class="topbar-link">
											...
											<div class="topbar-link-wrapper">   
													<div class="header-menu-links">	
															...
															'menu' => esc_html__('TM Header Top Links','megashop-multistore'),
															'depth'=> 1,
															'echo' => false,
															...
															if ( is_user_logged_in() ) {
																...
																<a href="<?php echo esc_url($logout_url); ?>" ><?php echo esc_html_e('Logout','megashop-multistore'); ?></a>
																<?php }
																else { ?>
																<a href="<?php echo  get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php echo esc_html_e('User Login','megashop-multistore'); ?></a>
															<?php } ?>  
													</div>			
												</div>
										</div>	
										...
										<!--Cart -->			
											...
											<div class="cart togg">
														...
														ob_start();?>						
														<div class="shopping_cart tog" title="<?php esc_attr_e('View your shopping cart', 'megashop-multistore'); ?>">
															<div class="cart-icon"></div>
															<div class="cart-price">
																<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'megashop-multistore'); ?>">
																	<span class="cart-qty"><?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'megashop-multistore'), $woocommerce->cart->cart_contents_count);?></span>
																	<div class="cart-label"><?php echo esc_html_e('My Cart','megashop-multistore'); ?></div>
				...
				<div class="header-bottom">
					<div class="theme-container">
							<div class="header-bottom-left">	
								...
								<div class="box-category-heading">
									<div class="box-category">
                                        <?php echo stripslashes(get_option( 'tmpmela_navbar_category_title' )); ?>
                                      </div>
									<!-- category block -->
							...
							<!-- #site-navigation -->
								...
								<a class="screen-reader-text skip-link" href="#content" title="<?php esc_attr_e( 'Skip to content', 'megashop-multistore' ); ?>"><?php esc_html_e( 'Skip to content', 'megashop-multistore' ); ?></a>	
									<div class="mega-menu">
						...
						<!-- Start header_bottom_right -->		
							<div class="header-bottom-right">
								...
								<h3 class="menu-toggle"><?php esc_html_e( 'Menu', 'megashop-multistore' ); ?></h3>
									<div class="mobile-menu">	
										<span class="close-menu"></span>	
											<?php wp_nav_menu( array( 'theme_location' => 'primary','menu_class' => 'mobile-menu-inner') ); ?>
										</div>
								</nav>
							    <?php if (get_option('tmpmela_show_header_cms') == 'yes') : ?> 	
