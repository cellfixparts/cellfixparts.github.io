  ...
  <div id="content" class="site-content" role="main">
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <div class="entry-main-content">
		...
		<?php the_content(); ?>
        <?php wp_link_pages( array( 'before' => '<div class="page-link">' . esc_html__( 'Pages:', 'megashop-multistore' ), 'after' => '</div>' ) ); ?>
      </div>
      ...
      <div class="entry-utility-port">
        <?php edit_post_link( esc_html__( 'Edit', 'megashop-multistore' ), '<span class="edit-link">', '</span>' ); ?>
      </div>
      <!-- .entry-utility -->
