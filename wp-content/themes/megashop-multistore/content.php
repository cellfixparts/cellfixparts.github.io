            ...
            <div class="entry-content-inner">
                ...
                if(!empty($postImage)): ?>
                   <div class="block_hover">
                    <div class="links">
                        <a href="<?php echo esc_url($postImage); ?>" title="<?php esc_attr_e( 'Click to view Full Image', 'megashop-multistore' );?>" data-lightbox="example-set" class="icon mustang-gallery"><i class="fa fa-plus"></i></a> <a href="<?php echo esc_url(get_permalink()); ?>" title="<?php esc_attr_e( 'Click to view Read More', 'megashop-multistore' );?>" class="icon readmore"><i class="fa fa-link"></i></a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
<?php else : ?>
    ...
    if( $post->post_title == '' ) :
        ...
        <div class="entry-content">
            ...
            $postImage = wp_get_attachment_url( get_post_thumbnail_id(get_the_ID()) );
            ?>
            <?php the_content( wp_kses( __('Read More <span class="meta-nav">&rarr;</span>', 'megashop-multistore' ),tmpmela_allowed_html())); ?>
            <?php wp_link_pages( array( 'before' => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'megashop-multistore' ) . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>' ) ); ?>
        </div><!-- .entry-content -->
		...
		<div class="entry-meta">
            ...
            <?php tmpmela_post_entry_date(); ?>
            <?php edit_post_link( esc_html__( 'Edit', 'megashop-multistore' ), '<div class="meta-inner"><span class="edit-link"><i class="fa fa-pencil"></i>', '</span></div>' ); ?>
        </div><!-- .entry-meta -->
    <?php endif; ?>
