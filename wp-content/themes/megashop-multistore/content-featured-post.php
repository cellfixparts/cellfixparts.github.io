...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>> <a class="post-thumbnail" href="<?php esc_url(the_permalink()); ?>">
  ...
  <header class="entry-header">
    ...
    <div class="entry-meta"> <span class="cat-links"><?php echo esc_attr(get_the_category_list( _x( ', ', 'Used between list items, there is a space after the comma.', 'megashop-multistore' ) )); ?></span> </div>
    <!-- .entry-meta -->
    <?php endif; ?>
