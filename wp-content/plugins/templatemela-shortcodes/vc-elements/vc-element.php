...
/**** Hot Product *****/	
		vc_map( array (
				...
				array (
					...
					'type' 			=> 'textfield',
					'heading' 		=> __('Limitation of Detail', 'tmpmela-opts'),
					'description' 	=> __('Limitation of Detail. ex.250', 'tmpmela-opts'),
					'admin_label'	=> false,
				),	
				)
	));
	...
	vc_map( array (
			...
			'params' 		=> array (
				...
				array (
					'param_name' 	=> 'excerpt_length',
					'type' 			=> 'textfield',
					'heading' 		=> __('Limitation of Description', 'tmpmela-opts'),
					'description' 	=> __('Limitation of Portfilio Description. ex.100', 'tmpmela-opts'),
					'admin_label'	=> false,
				),
