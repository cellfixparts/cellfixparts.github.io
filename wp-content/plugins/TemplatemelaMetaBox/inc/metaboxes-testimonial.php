...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - List Options', 'multistore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'local_images' => true,
	'fields' 	=> array(	
		...
		array(
			'name'			=> esc_html__('Number of posts per page:', 'multistore'),
...
$TM_META_BOXES[] = array(
	...
	'title' 	=> esc_html__('TM - Box Options', 'multistore'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'local_images' => true,
	'fields' 	=> array(	
		...
		array(
			'name'    		=> esc_html__('Columns Options:', 'multistore'),
			'id'      		=> "{$prefix}columns",
			'type'    		=> 'radio',
			'std'			=> 'two',
			'options'		=> array(
