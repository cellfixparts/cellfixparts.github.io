...
if ( !class_exists( 'RWMB_Post_Field' ) )
{
	class RWMB_Post_Field extends RWMB_Field
	{
		...
		{
			$default_post_type = esc_html__( 'Post', 'megashop-multistore' );
			...
			$field['std'] = empty( $field['std'] ) ? sprintf( esc_html__( 'Select a %s', 'megashop-multistore' ), $default_post_type ) : $field['std'];
